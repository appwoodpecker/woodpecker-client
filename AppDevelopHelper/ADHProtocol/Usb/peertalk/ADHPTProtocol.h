...
static const uint32_t ADHPTFrameNoTag = 0;

// Special frame type that signifies that the stream has ended.
static const uint32_t ADHPTFrameTypeEndOfStream = 0;

// NSError domain
FOUNDATION_EXPORT NSString * const ADHPTProtocolErrorDomain;


@interface ADHPTProtocol : NSObject
...
@interface NSData (ADHPTProtocol)
...
@interface NSDictionary (ADHPTProtocol)
// See description of -[NSData(ADHPTProtocol) createReferencingDispatchData]
- (dispatch_data_t)createReferencingDispatchData;
@end
