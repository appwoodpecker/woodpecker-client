...
//  }
//
FOUNDATION_EXPORT NSNotificationName const ADHPTUSBDeviceDidAttachNotification NS_SWIFT_NAME(deviceDidAttach);
...
//  }
//
FOUNDATION_EXPORT NSNotificationName const ADHPTUSBDeviceDidDetachNotification NS_SWIFT_NAME(deviceDidDetach);

typedef NSString * ADHPTUSBHubNotificationKey NS_TYPED_ENUM;
FOUNDATION_EXPORT ADHPTUSBHubNotificationKey const ADHPTUSBHubNotificationKeyDeviceID NS_SWIFT_NAME(deviceID);
FOUNDATION_EXPORT ADHPTUSBHubNotificationKey const ADHPTUSBHubNotificationKeyMessageType NS_SWIFT_NAME(messageType);
FOUNDATION_EXPORT ADHPTUSBHubNotificationKey const ADHPTUSBHubNotificationKeyProperties NS_SWIFT_NAME(properties);

// NSError domain
FOUNDATION_EXPORT NSString * const ADHPTUSBHubErrorDomain;

// Error codes returned with NSError.code for NSError domain PTUSBHubErrorDomain
typedef enum {
  ADHPTUSBHubErrorBadDevice = 2,
  ADHPTUSBHubErrorConnectionRefused = 3,
} ADHPTUSBHubError;

@interface ADHPTUSBHub : NSObject
