...
@class ADHGCDAsyncReadPacket;
@class ADHGCDAsyncWritePacket;
@class ADHGCDAsyncSocketPreBuffer;
@protocol ADHGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN


typedef NS_ENUM(NSInteger, ADHGCDAsyncSocketError) {
	ADHGCDAsyncSocketNoError = 0,           // Never used
	ADHGCDAsyncSocketBadConfigError,        // Invalid configuration
	ADHGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	ADHGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	ADHGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	ADHGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	ADHGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	ADHGCDAsyncSocketClosedError,           // The remote peer closed the connection
	ADHGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface ADHGCDAsyncSocket : NSObject
...
- (instancetype)initWithDelegate:(nullable id<ADHGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<ADHGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<ADHGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<ADHGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<ADHGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<ADHGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<ADHGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<ADHGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
 ...
 * it is treated similarly to a timeout - the socket is closed with a ADHGCDAsyncSocketReadMaxedOutError.
...
@protocol ADHGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(ADHGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(ADHGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(ADHGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(ADHGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (void)socketDidCloseReadStream:(ADHGCDAsyncSocket *)sock;
...
**/
- (void)socketDidSecure:(ADHGCDAsyncSocket *)sock;
...
**/
- (void)socket:(ADHGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
