//
//  ViewPopupAttributeCell.m
//  WoodPecker
//
//  Created by 张小刚 on 2019/3/2.
//  Copyright © 2019 lifebetter. All rights reserved.
//

#import "ViewPopupAttributeCell.h"

@interface ViewPopupAttributeCell ()
...
@implementation ViewPopupAttributeCell
...
- (IBAction)popupButtonValueChanged:(id)sender {
    ...
    if(index != NSNotFound && index < self.itemList.count) {
        ...
        [self.delegate stateUpdateRequest:self value:value info:nil];
    }
}
