//
//  CloudUserDefaultsViewController.m
//  Woodpecker
//
...
@interface CloudUserDefaultsViewController ()<NSOutlineViewDataSource,NSOutlineViewDelegate,ADHBaseCellDelegate>
...
@implementation CloudUserDefaultsViewController
...
- (void)loadContent {
    ...
    [self.apiClient requestWithService:@"adh.icloud" action:@"requestUserDefaults" body:body onSuccess:^(NSDictionary *body, NSData *payload) {
...
- (void)removeMenuSelected: (NSMenuItem *)menu {
    ...
    [ADHAlert alertWithMessage:@"Remove item" infoText:@"Are you sure to remove it" comfirmBlock:^{
        ...
        __weak typeof(self) wself = self;
        [self.apiClient requestWithService:@"adh.icloud" action:@"removeUserDefaults" body:data onSuccess:^(NSDictionary *body, NSData *payload) {
            [wself.view hideHud];
...
- (void)requestUpdateItem: (ADHKVItem *)item {
    ...
    __weak typeof(self) wself = self;
    [self.apiClient requestWithService:@"adh.icloud" action:@"updateUserDefaults" body:body payload:payload progressChanged:nil onSuccess:^(NSDictionary *body, NSData *payload) {
...
- (void)addPinItem: (NSString *)key {
    ...
    [ADHUserDefaultUtil setDefaultValue:mlist forKey:@"pinlist" inDomain:kToolModuleiCloud];
...
- (NSArray *)getPinList {
    ...
    NSArray *list = [ADHUserDefaultUtil defaultValueForKey:key inDomain:kToolModuleiCloud];
    return list;
}
